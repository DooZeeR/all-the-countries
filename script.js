...
function loadEvent() {
    ...
    console.log("Perus length", peru.length);
    ...
    function landLocked () {
        console.log(peruO.landlocked);  // control only
       
        
        // with ternary operator
        const landLockedHTML = (peruO.landlocked) ? `<h5>I have never met the seashore</h5>` : ``;
        return landLockedHTML;
        
        
        /*
        const landLockedHTML = `
        <h5>I have never met the seashore</h5>
        `;  
        if (peruO.landlocked) {
            return landLockedHTML;
        }else{
    ...
    console.log("Tömb vagyok-e?:  ", Array.isArray(peru));
    ...
    const peruHTML = `
        <section class="independent">
            ...
            <ul>
                <li>first language: ${peruO.languages.aym}</li>
            </ul>
            <!-- Ha a landlocked true <h5>I have never met the seashore</h5> -->
            ${landLocked()}
        </section>
    `;
